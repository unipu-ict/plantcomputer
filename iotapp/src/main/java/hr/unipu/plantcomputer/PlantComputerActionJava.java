 ...
 */
public enum PlantComputerActionJava {
    ...
    PlantComputerActionJava(String id, String actionName, String actionValue) {
        this.id = id;
        this.actionName = actionName;
        this.actionValue = actionValue;
    }

    public static PlantComputerActionJava fromId(String id) {
        for (PlantComputerActionJava plantComputerAction : PlantComputerActionJava.values()) {
    ...
    public static PlantComputerActionJava fromNameAndValue(String actionName, String actionValue) {
        for (PlantComputerActionJava plantComputerAction : PlantComputerActionJava.values()) {
    ...
    public PlantComputerActionJava setActionValue(String actionValue) {
        this.actionValue = actionValue;
        return this;
    }
